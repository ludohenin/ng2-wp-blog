...
export class SeedConfig {
  ...
  DEV_NPM_DEPENDENCIES: InjectableDependency[] = this.normalizeDependencies([
  ...
  PROD_NPM_DEPENDENCIES: InjectableDependency[] = this.normalizeDependencies([
    { src: 'systemjs/dist/system-polyfills.src.js', inject: 'shims' },
    { src: 'reflect-metadata/Reflect.js', inject: 'shims' },
  ...
  normalizeDependencies(deps: InjectableDependency[]) {
    deps
